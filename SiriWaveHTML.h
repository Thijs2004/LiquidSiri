static NSString * const siriWaveHTML = @""
"<!DOCTYPE html>\n"
"<html lang=\"zh\">\n"
"<head>\n"
"<meta charset=\"UTF-8\">\n"
"<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n"
"<title>Siri RE Shaders (iOS 27)</title>\n"
"<style>\n"
"  * { margin:0; padding:0; box-sizing:border-box; }\n"
"  html,body { height:100%; background:transparent; overflow:hidden; font-family:-apple-system,system-ui,sans-serif;\n"
"    display:flex; align-items:center; justify-content:center; }\n"
"  #gl { display:block; width:100vw; height:100vh; background:transparent; }\n"
"  #seg { position:fixed; top:14px; left:50%; transform:translateX(-50%);\n"
"    display:flex; gap:6px; background:rgba(20,20,22,0.8); backdrop-filter:blur(20px);\n"
"    border:1px solid rgba(255,255,255,0.12); border-radius:12px; padding:5px; }\n"
"  #seg button { padding:7px 16px; border-radius:8px; border:none; background:transparent;\n"
"    color:#ccc; font-size:13px; cursor:pointer; }\n"
"  #seg button.on { background:#5b7cfa; color:#fff; }\n"
"  #err { position:fixed; left:12px; bottom:12px; right:12px; max-width:820px;\n"
"    background:rgba(180,30,20,0.92); color:#fff; padding:10px 14px; border-radius:10px;\n"
"    font-family:ui-monospace,Menlo,monospace; font-size:12px; white-space:pre-wrap; display:none; }\n"
"</style>\n"
"</head>\n"
"<body>\n"
"<canvas id=\"gl\"></canvas>\n"
...
"    col *= res;\n"
"    float a = max(col.r, max(col.g, col.b)); fragColor = vec4(col, a);\n"
"}\n"
"void main(){ mainImage(gl_FragColor, gl_FragCoord.xy); }\n"
"</script>\n"
"\n"
"<!-- ============ ORB: siriFluidDotsCore (metaball + smin) ============ -->\n"
...
"\n"
"<script>\n"
"const canvas=document.getElementById('gl'), errBox=document.getElementById('err');\n"
"const gl=canvas.getContext('webgl', {alpha:true});\n"
"let prog=null, U={}, buf=null;\n"
"\n"
"function compile(type,src){\n"
"  const s=gl.createShader(type); gl.shaderSource(s,src); gl.compileShader(s);\n"
"  if(!gl.getShaderParameter(s,gl.COMPILE_STATUS)){\n"
"    errBox.style.display='block'; errBox.textContent='编译错误:\\n'+gl.getShaderInfoLog(s);\n"
...
"  if(!buf){ buf=gl.createBuffer(); gl.bindBuffer(gl.ARRAY_BUFFER,buf);\n"
"    gl.bufferData(gl.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),gl.STATIC_DRAW); }\n"
"  const aPos=gl.getAttribLocation(prog,'aPos');\n"
"  gl.enableVertexAttribArray(aPos); gl.vertexAttribPointer(aPos,2,gl.FLOAT,false,0,0);\n"
"  U.iResolution=gl.getUniformLocation(prog,'iResolution');\n"
"  U.iTime=gl.getUniformLocation(prog,'iTime');\n"
"}\n"
"let cur='fs-wave';\n"
"\n"
"});\n"
"const RENDER_SCALE = 0.75;            // 内部分辨率倍率，越小越省、越糊;卡就调 0.5\n"
"function resize(){ const css=window.innerWidth;     // CSS 显示尺寸,见上面 #gl\n"
"  canvas.width=Math.round(css*RENDER_SCALE); canvas.height=Math.round(css*RENDER_SCALE);\n"
"  gl.viewport(0,0,canvas.width,canvas.height); }\n"
"resize(); build(cur);\n"
"const start=performance.now();\n"
"function frame(){ const t=(performance.now()-start)/1000;\n"
"  gl.uniform2f(U.iResolution,canvas.width,canvas.height); gl.uniform1f(U.iTime,t);\n"
