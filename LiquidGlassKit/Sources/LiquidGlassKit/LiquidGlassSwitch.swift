...
open class LiquidGlassSwitch: UIControl {
    ...
    private lazy var expandedThumbView: LiquidGlassView = {
        // Same fullQuality=true as LiquidGlassSlider's expandedThumbView — per-view
        // high-resolution capture gives the same sharp glass appearance on both controls.
        return LiquidGlassView(.thumb(magnification: 0.75))
    }()
